...
def CofA_variable_additions(list_builder, lot):
    ...
    temp_list[2][0] = "Batch #: {}".format(sh.cell_value(rowx=found_row, colx=2))     # C
    temp_list[3][0] = "Lot #: {}".format(sh.cell_value(rowx=found_row, colx=1))     # B
    ...
    temp_list[13][1] = sh.cell_value(rowx=found_row, colx=23)   # y
    temp_list[14][1] = sh.cell_value(rowx=found_row, colx=24)   # X
    ...
    temp_list[19][1] = "{} Cp".format(sh.cell_value(rowx=found_row, colx=16))   # Q
